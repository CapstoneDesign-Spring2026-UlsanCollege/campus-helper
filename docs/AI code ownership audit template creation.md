...
Evidence can be a demo video, screenshot, PR, issue, test result, or deployed link.
...
| Login form | `src/components/LoginForm.jsx` | Collects email/password and sends login request | Mina | PR #18 |
