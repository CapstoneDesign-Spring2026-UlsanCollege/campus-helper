...
export function StudioHero({
  ...
  return (
    <Card className="hero-surface p-0">
      ...
      <div className="relative grid gap-6 px-6 py-7 md:grid-cols-[1fr_auto] md:px-8 md:py-9">
        <div className="max-w-2xl">
          <div className="section-kicker">
            <Icon size={13} className={accentClassName} />
            <span>{badge}</span>
          </div>
          <h1 className="mt-5 max-w-3xl text-3xl font-semibold tracking-tight text-white md:text-4xl">{title}</h1>
          <p className="mt-3 max-w-2xl text-sm leading-7 text-gray-300 md:text-base">{description}</p>
        </div>
